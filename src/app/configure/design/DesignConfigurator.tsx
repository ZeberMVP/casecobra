...
const DesignConfigurator = ({
  ...
  return (
    <div className='relative mb-20 mt-20 grid grid-cols-1 pb-20 lg:grid-cols-3'>
      <div
        ref={containerRef}
        className='focus:outline-ring-2 relative col-span-2 flex h-[37.5rem] w-full max-w-4xl items-center justify-center overflow-hidden rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-primary focus:ring-offset-2'
      >
