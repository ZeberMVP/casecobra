    ...
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 sm:pb-32 lg:grid lg:grid-cols-3 lg:gap-x-0 lg:pb-52 lg:pt-24 xl:gap-x-8 xl:pt-32">
          ...
          <div className="col-span-full mt-32 flex h-fit w-full justify-center px-8 sm:px-16 lg:col-span-1 lg:mx-0 lg:mt-20">
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="lg-mx-0 mx-auto grid max-w-2xl grid-cols-1 gap-y-16 px-4 lg:max-w-none lg:grid-cols-2">
